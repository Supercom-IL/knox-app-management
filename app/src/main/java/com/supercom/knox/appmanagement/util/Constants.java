...
public interface Constants {
    ...
    String KPE_LICENSE_KEY_OLD = "KLM09-CH1J5-Y5H84-3VPMH-WWZVF-2HD28"; // OLD 09/01/2024
    String KPE_LICENSE_KEY = "KLM09-G1PKQ-6NU75-P3C60-NIBPO-WM1I3"; // MOBILE COMMERCIAL KEY - WORKING
